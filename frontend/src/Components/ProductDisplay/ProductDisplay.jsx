        ...
        <div className="w-1/2 flex flex-col pl-8 gap-y-4">
            ...
            <div className="flex flex-col mt-6 gap-y-6">
                ...
                <div className="flex flex-row gap-x-4">
                    <button className='w-[60px] bg-slate-100 font-light p-4 border-[1px] border-gray-200'>S</button>
                    <button className='w-[60px] bg-slate-100 font-light p-4 border-[1px] border-gray-200'>M</button>
                    <button className='w-[60px] bg-slate-100 font-light p-4 border-[1px] border-gray-200'>L</button>
                    <button className='w-[60px] bg-slate-100 font-light p-4 border-[1px] border-gray-200'>XL</button>
                </div>
                <button className='uppercase bg-red-500 px-8 py-4 w-[180px] text-white font-medium'>Add To Cart</button>
            </div>

            <div className="flex flex-col gap-y-6 mt-6">
                <h1><strong>Category:</strong> {product.category}</h1>
                <h2><strong>Tags:</strong> Rings, Discount, Gold</h2>
            </div>
